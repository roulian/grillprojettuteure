...
/**
 * Classe contenant les constantes contenant les images du projet
 * @author Andres Gomez Thomas
 * @version 1.0
 */
public final class IconBat {
	...
	public static final String NUM1RED = "images/num1Red.PNG" ;
	public static final String NUM2RED = "images/num2Red.PNG" ;
	public static final String NUM3RED = "images/num3Red.PNG" ;
	public static final String NUM4RED = "images/num4Red.PNG" ;
	public static final String NUM5RED = "images/num5Red.PNG" ;
	public static final String NUM6RED = "images/num6Red.PNG" ;
